...
public class RedPacketTradeOrderServiceImpl implements RedPacketTradeOrderService {
    ...
    @Override
    @Tyloo(confirmMethod = "confirmRecord", cancelMethod = "cancelRecord", tylooContextLoader = TylooTransactionContextLoader.class)
    @Transactional
    ...
    @Transactional
    public void cancelRecord(TylooTransactionContext transactionContext, RedPacketTradeOrderDto tradeOrderDto) {
